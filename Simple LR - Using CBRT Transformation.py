...
X_log = np.cbrt(df['Sorting Time'].values.reshape(-1,1))
...
X_log = np.cbrt(df['YearsExperience'].values.reshape(-1,1))
#using [[]] for two dimention, as SKlearn's X variable in line 43, always uses two dimention data, only for simple linear regression.
...
#metrics.r2_score(Y_test_log, l_model))
#Mean Absolute Error: 6631.133710910425
#Mean Squared Error: 56028773.14122633
#Root Mean Squared Error: 7485.237013029469
#R^2 Score :           0.8903108494790042
############################################
